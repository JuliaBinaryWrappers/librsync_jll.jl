...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import librsync_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6c5fa084-3dbe-5c56-adb0-3ea4e9e901c0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "librsync", artifacts_toml) for e in artifacts["librsync"]]
...
if best_platform === nothing
    @debug("Unable to load librsync; unsupported platform $(triplet(platform_key_abi()))")
else
